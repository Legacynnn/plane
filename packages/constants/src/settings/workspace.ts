...
export const WORKSPACE_SETTINGS: Record<TWorkspaceSettingsTabs, TWorkspaceSettingsItem> = {
  ...
  connectors: {
    ...
    i18n_placeholder: "workspace_settings.settings.connectors.placeholder",
  ...
  repositories: {
    ...
    i18n_placeholder: "workspace_settings.settings.repositories.placeholder",
  ...
  "code-scopes": {
    ...
    i18n_placeholder: "workspace_settings.settings.code_scopes.placeholder",
  ...
  "agent-defaults": {
    ...
    i18n_placeholder: "workspace_settings.settings.agent_defaults.placeholder",
  ...
  "workspace-preferences": {
    ...
    i18n_placeholder: "workspace_settings.settings.workspace_preferences.placeholder",
  ...
  "workspace-pool": {
    ...
    i18n_placeholder: "workspace_settings.settings.workspace_pool.placeholder",
    href: `/settings/pool`,
    access: ADMIN_ONLY,
  },
  "api-tokens": {
    ...
    i18n_placeholder: "workspace_settings.settings.workspace_api_tokens.placeholder",
  ...
  "mcp-access": {
    ...
    i18n_placeholder: "workspace_settings.settings.mcp_access.placeholder",
    href: `/settings/mcp`,
    access: ADMIN_ONLY,
  },
};
